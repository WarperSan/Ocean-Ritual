...
namespace DhafinFawwaz.AnimationUILib.Demo
{
    ...
    public struct ScaleBlock : IEquatable<ScaleBlock>
    {
        ...
        public bool Equals(ScaleBlock other) => normalScale == other.normalScale &&
        ...
        public static bool operator ==(ScaleBlock point1, ScaleBlock point2) => point1.Equals(point2);
