...
namespace DhafinFawwaz.AnimationUILib.Demo
{
    ...
    {
        [SerializeField]
        private ColorBlock _textColors = ColorBlock.defaultColorBlock;

        [SerializeField]
        private ScaleBlock _scales = ScaleBlock.defaultScaleBlock;
        ...
        protected override void Awake() => transition = Transition.None;
        ...
        public void OnSubmit(BaseEventData eventData)
        {
            ...
            {
                StartCoroutine(TweenLocalScale(targetGraphic.transform,
                    Vector3.one * _scales.pressedScale,
                    Vector3.one * _scales.highlightedScale,
                    _scales.fadeDuration,
                    Ease.InOutQuart));

                StartCoroutine(TweenGraphicColor(targetGraphic,
                    colors.pressedColor,
            ...
            if (_text != null)
                StartCoroutine(TweenTextMeshProColor(_text,
                    _textColors.pressedColor,
                    _textColors.highlightedColor,
                    _textColors.fadeDuration,
                    Ease.OutQuart));
        }
        ...
        public override void OnPointerDown(PointerEventData eventData)
        {
            ...
            {
                StartCoroutine(TweenLocalScale(targetGraphic.transform,
                    targetGraphic.transform.localScale,
                    Vector3.one * _scales.pressedScale,
                    _scales.fadeDuration,
                    Ease.OutBackQuart));
        ...
        public override void OnPointerExit(PointerEventData eventData)
        {
            ...
            if (targetGraphic != null)
            {
                StartCoroutine(TweenLocalScale(targetGraphic.transform,
                    targetGraphic.transform.localScale,
                    Vector3.one * _scales.normalScale,
                    _scales.fadeDuration,
                    Ease.OutBackQuart));
        ...
        public override void OnSelect(BaseEventData eventData)
        {
            ...
            if (targetGraphic != null)
            {
                StartCoroutine(TweenLocalScale(targetGraphic.transform,
                    targetGraphic.transform.localScale,
                    Vector3.one * _scales.selectedScale,
                    _scales.fadeDuration,
                    Ease.OutBackQuart));
        ...
        private IEnumerator TweenGraphicColor(
            Graphic       graphic,
            Color         start,
            Color         end,
            float         duration,
        ...
        private IEnumerator TweenLocalScale(
            Transform     trans,
            Vector3       start,
            Vector3       end,
            float         duration,
        ...
        private IEnumerator TweenTextMeshProColor(
            TMP_Text      text,
            Color         start,
            Color         end,
            float         duration,
        ...
        private static void CreateButtonUI(MenuCommand menuCommand)
        {
            ...
            var createdGo = new GameObject("ButtonUI");
            ...
            var graphicColorBlock = new ColorBlock
            {
                normalColor = new Color32(0x30,
                    0x30,
                    0x30,
                    0xff),
                highlightedColor = new Color32(0x43,
                    0x43,
                    0x43,
                    0xff),
                pressedColor = Color.white,
                selectedColor = new Color32(0x43,
                    0x43,
                    0x43,
                    0xff),
                disabledColor = new Color32(0x71,
                    0x71,
                    0x71,
                    0xff),
                fadeDuration = 0.15f,
            ...
            var textColorBlock = new ColorBlock
            {
                ...
                pressedColor = new Color32(0x30,
                    0x30,
                    0x30,
                    0xff),
                selectedColor = Color.white,
                disabledColor = new Color32(0xA8,
                    0xA8,
                    0xA8,
                    0xff),
                fadeDuration = 0.15f,
    ...
    {
        private string[] _excludedPropertyIndexes = new string[]
        {
            "m_Transition",
            "m_SpriteState",
            "m_AnimationTriggers",
        ...
        public override void OnInspectorGUI()
        {
            ...
            var label = new GUIContent("Scales");
        ...
        private GUIContent m_VisualizeNavigation =
        ...
        private static List<ButtonUI2Editor> s_Editors = new();
        ...
        private static void DrawNavigationArrow(Vector2 direction, Selectable fromObj, Selectable toObj)
        {
            ...
            Handles.DrawAAPolyLine(kArrowThickness,
                toPoint,
