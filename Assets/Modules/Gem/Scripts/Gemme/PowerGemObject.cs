...
public class PowerGemObject
{
    ...
    {
        // Cr�e une liste temporaire pour stocker les enfants � supprimer
        var children = new List<GameObject>();

        // Ajoute chaque enfant � la liste temporaire
        foreach (Transform child in container.transform)
            children.Add(child.gameObject);

        // Supprime chaque enfant apr�s la fin de l'it�ration
    ...
    public void DeletedGem(Gem theGem)
    {
        if (GemmeList.Contains(theGem))
        {
            ...
            // Debug.Log("La gemme a �t� supprim�e avec succ�s.");
        }
        else
            Debug.LogWarning("La gemme sp�cifi�e n'existe pas dans la liste.");
    }
