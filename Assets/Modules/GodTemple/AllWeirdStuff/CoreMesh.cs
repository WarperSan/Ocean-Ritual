...
{
    [SerializeField]
    private Vector2Int numVertices;
    ...
    {
        var vertices = new Vector3[numVertices.x * numVertices.y + 2];
    ...
    private Vector2[] GetUvs() => new Vector2[numVertices.x * numVertices.y + 2];

    private int GetIndex(int hIndex, int vIndex) => vIndex * numVertices.x + hIndex + 1;
}