...
public class BallGenerator : MonoBehaviour
{
    ...
    public static BallGenerator objectPool;
    ...
    public GameObject GetBall(GameObject typeObject, Transform parent)
    {
       
        GameObject balle = GetObject(typeObject);

      
        balle.transform.SetParent(parent);
