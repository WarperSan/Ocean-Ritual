...
namespace TortueNode
{
    ...
    public class Cooldown : Node
    {
        ...
        public Cooldown(float TimeBetwenneAttack, bool impactReset = false)
        {
            ...
            this.timeLapse = 0f; // Initialiser le temps �coul� � z�ro
    ...
    {
        DistanceSmaller DistanceSmaller; // Peut �tre une autre Node si vous en avez besoin
        Node root;
        Transform self;
        string targets; // Nom ou cl� des cibles
        float distance; // Distance de proximit� � v�rifier
        public const string NeedFolow = "needFolow";
