...
namespace Singletons
{
    ...
    public class FishingManager : Singleton<FishingManager>
    {
        ...
        public void Create()
        {
            IEnumerable<TerritoryScript> territories = GetTerritories(this.transform.position, 5);
        ...
        private static IEnumerable<TerritoryScript> GetTerritories(Vector3 origin, float radius)
        {
            var territories = new List<TerritoryScript>();
            ...
            foreach (Collider collider in colliders)
            {
                ...
                if (!collider.TryGetComponent(out TerritoryScript territory))
                    continue;
